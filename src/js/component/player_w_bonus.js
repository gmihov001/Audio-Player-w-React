...
export const Player4 = () => {
	...
	const changePosition = (a) => {
		let divBy100 = player.duration / 100;
		player.currentTime = a * divBy100;
	...
	return (
		<div className="player">
			...
			<input type="range" min="0" max="100" step="1" onChange={(e) => changePosition(e.target.value)} />
		</div>
	);
};
